# Web to Podcast Generator

基于 n8n 和豆包 API 的自动化网页转播客系统。

## 功能特性

- **智能内容提取**：自动过滤广告、导航等无效内容
- **播客脚本生成**：将文章转化为口语化播客脚本
- **动态音色选择**：根据内容类型自动选择合适的音色
- **TTS 音频合成**：使用豆包 TTS API 生成高质量语音
- **自动化工作流**：一键从 URL 到播客音频
